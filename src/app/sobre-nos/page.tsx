  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-r from-[#21CCBC] via-[#85F1B2] to-[#B6DD6A]">
      <div className="relative z-10 flex-grow p-6">
        <div className="flex justify-between items-center my-8">
          ...
          <div>
            <Link
              href="/modulos"
              className="text-black mr-4 hover:underline transition-colors"
            >
        ...
        <div className="text-black grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 my-10 p-10">
          <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center text-center">
            ...
            />
            <h2 className="text-2xl font-semibold text-[#21CCBC]">
              Gustavo Monção
            </h2>
            <p className="mt-2 text-gray-600 text-sm">
              LinkedIn:
              <a
                href="https://www.linkedin.com/in/gustavo-monção-574a38224/"
                target="_blank"
            ...
            <p className="text-gray-600 text-sm">
              GitHub:
              <a
                href="https://github.com/moncaogustavo"
                target="_blank"
                className="text-blue-500 hover:underline flex items-center"
              >
            ...
            <p className="text-gray-600 text-sm">
              RM: <span className="text-blue-500">557515</span>
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm">
              GitHub:
              <a
                href="https://github.com/Gustavo295"
                target="_blank"
                className="text-blue-500 hover:underline flex items-center"
              >
            ...
            <p className="text-gray-600 text-sm">
              RM: <span className="text-blue-500">555010</span>
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm">
              RM: <span className="text-blue-500">558763</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <footer className="bg-gradient-to-r from-[#21CCBC] via-[#85F1B2] to-[#B6DD6A] text-black p-4 text-center">
        <p className="text-sm">
          &copy; 2024 Sparkuest - Todos os direitos reservados.
        </p>
      </footer>
    </div>
  );
